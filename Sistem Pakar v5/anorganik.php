...
<head>
    ...
    <title>Anorganik | Organik Anorganik Identify</title>

<!-- font awesome cdn link -->
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">

<!-- css-->
<link rel="stylesheet" href="css/styleAnorganik.css">
...
<section class="home" id="home">
    ...
    <div class="container background">
        <div class="row">
            <div class="image">
                <img src="img/anorganik.png" alt="about" class="sampah">
            </div>
    
            <div class="content">
                <h3>Anorganik</h3>
                <p>Sampah yang kamu upload merupakan sampah Anorganik, silahkan membuang sampah tersebut kedalam <span>tong sampah Anorganik</span>.</p>
                <p>Sampah Anorganik merupakan sampah yang <span>tidak dapat terurai secara alami</span>.</p>
                <p>Cth, Sisa makanan, Sayuran, Tanaman, Sisa pengolahan makanan, Kotoran hewan.</p>
            </div>
        </div>
    </div>
</section>
