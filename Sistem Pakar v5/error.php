...
<head>
    ...
    <title>Not Definde | Organik Anorganik Identify</title>
...
<section class="home" id="home">
    ...
    <div class="container background">
        <div class="row">
            <div class="image">
                <img src="img/error3.png" alt="about" class="sampah">
            </div>
    
            <div class="content">
                <h3>Can’t Identify</h3>
                <p>Oops! Maaf, foto atau gambar yang kamu masukkan tidak <span>dapat diidentifikasi</span>.</p>
